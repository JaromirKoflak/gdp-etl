...
The following table shows the largest discrepancies in the year `r last_year-1`.
...
The following table highlights the largest discrepancies found for each economy.
